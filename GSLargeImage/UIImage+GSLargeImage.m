//
//  UIImage+GSLargeImage.m
//  GSLargeImageDemo
//
//  Created by MarsGao on 16/8/26.
//  Copyright © 2016年 MarsGao. All rights reserved.
//

#import "UIImage+GSLargeImage.h"
//1M = 1048576.0f byte
...
@implementation UIImage (GSLargeImage)

+ (UIImage *)gs_largeImage:(UIImage *)largeImage{
    UIImage *originalImage = largeImage;
    if (!originalImage) {
        return nil;
    }
    __block CGContextRef destContext;
   __block UIImage *destImage;
